...
Ansible ругается на вывод этих команд, возможно из за того что во время выпонения этих команд довольно долго прогружаются дашборды для kibana. Поэтому из нужно будет запустить из вручную один раз.
